...
public class RoundHelper {
    ...
    public void setRadius(float radiusTopLeftDp, float radiusTopRightDp, float radiusBottomLeftDp, float radiusBottomRightDp) {
        ...
        mRadiusTopLeft = dp2px(radiusTopLeftDp);
        mRadiusTopRight = dp2px(radiusTopRightDp);
        mRadiusBottomLeft = dp2px(radiusBottomLeftDp);
        mRadiusBottomRight = dp2px(radiusBottomRightDp);
        if (mView != null) {
            mView.invalidate();
        }
    }
    ...
    public void setRadiusTopRight(float radiusDp) {
        ...
        mRadiusTopRight = dp2px(radiusDp);
        if (mView != null) {
            mView.invalidate();
        }
    }
    ...
    public void setRadiusBottomLeft(float radiusDp) {
        ...
        mRadiusBottomLeft = dp2px(radiusDp);
        if (mView != null) {
            mView.invalidate();
        }
    }
    ...
    public void setRadiusBottomRight(float radiusDp) {
        ...
        mRadiusBottomRight = dp2px(radiusDp);
        if (mView != null) {
            mView.invalidate();
        }
    }
