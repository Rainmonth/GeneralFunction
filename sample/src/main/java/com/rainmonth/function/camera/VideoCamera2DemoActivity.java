...
import com.rainmonth.function.widget.AutoFitTextureView;
...
public class VideoCamera2DemoActivity extends AppCompatActivity implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public static void start(Context context) {
        ...
        Intent intent = new Intent(context, VideoCamera2DemoActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_camera_demo2);
        ...
        try {
            ...
            mCameraDevice.createCaptureSession(surfaces, new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigureFailed(@NonNull CameraCaptureSession cameraCaptureSession) {
                    ...
                    ToastUtils.showToast(getActivity(), "Failed");
                }
            }, mBackgroundHandler);
